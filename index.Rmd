...
#for the 1 minute data it will be 1440
  if (num_observations == 288) {
    ...
    print(paste("ALERT, there were some missing observations on", most_recent_date, "in", lake_name, "Lake."))
    data_times <- as.POSIXct(current_data_recent$Time, format = "%H:%M")
    # Generate all possible times in a day with 5-minute interval. for the 1 minute data this will be different 
