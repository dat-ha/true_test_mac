...
#for the 1 minute data it will be 1440
  if (num_observations == 288) {
    ...
    print(paste("You've been cursed by Father Hesburgh! There are", length(missing_times), "missing observations on", most_recent_date, 'in', lake_name, "Lake."))
    print(paste("Missing times in", lake_name, "Lake:", missing_times))
  }
}
```
